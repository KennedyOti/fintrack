...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Update the expense category details</p>
    </div>
    <a href="{{ route('expenses.categories.index') }}" class="btn btn-outline-secondary">
...
<div class="row">
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <form method="POST" action="{{ route('expenses.categories.update', $category->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
