...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">Record a new expense and attach a receipt</p>
    </div>
                ...
                <form method="POST" action="{{ route('expenses.store') }}" enctype="multipart/form-data" id="expenseForm">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('expense_date') is-invalid @enderror"
                                       id="expense_date" name="expense_date" required value="{{ old('expense_date', date('Y-m-d')) }}">
                                @error('expense_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('vendor_name') is-invalid @enderror"
                               ...
                               placeholder="e.g., Office Supplies Inc." value="{{ old('vendor_name') }}">
                        @error('vendor_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('reference_number') is-invalid @enderror"
                                       ...
                                       placeholder="e.g., INV-001" value="{{ old('reference_number') }}">
            ...
            <div class="card-body">
                ...
                <div id="receiptDropZone" class="receipt-drop-zone" onclick="document.getElementById('receiptInput').click()">
                    ...
                    <div id="dropZonePrompt">
                        ...
                        <p class="receipt-drop-label">Drop receipt here or <span class="text-primary">browse</span></p>
