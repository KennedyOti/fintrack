...
@section('title', 'Add Income Category - FinTrack')

@section('content')
<!-- Page Header -->
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-0">Add Income Category</h4>
        <p class="text-muted mb-0">Create a new income category</p>
    </div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('income.categories.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" required maxlength="150" placeholder="e.g., Freelance Work">
                        @error('name')
